<footer>
  <div class="content">
    ...
    <div class="box">
      <h3>contact us</h3>
      <p><i class="bx bxs-phone"></i>+8801682062401</p>
      <p><i class="bx bxs-envelope"></i>abdullahalmahmudjoy39@gmail.com</p>
      <p><i class="bx bxs-location-plus"></i>Dhaka, Bangladesh</p>
      <div class="icons">
        <a href="https://www.facebook.com/aamjoy39" target="_blank"><i class="bx bxl-facebook"></i></a>
        <a href="https://www.instagram.com/aal_mahmud/" target="_blank"><i class="bx bxl-instagram"></i></a>
        <a href="https://x.com/Almahmud39" target="_blank"><i class="bx bxl-twitter"></i></a>
        <a href="https://www.linkedin.com/in/abdullah-al-mahmud-joy-359112202/" target="_blank"><i class="bx bxl-linkedin"></i></a>
      </div>
    </div>
  </div>
  <div class="bottom">
    <p>Copyright 2024. All rights reserved to Teams.</p>
  </div>
</footer>
